...
if _version_not_supported:
    raise RuntimeError(
        ...
        + ' but the generated code in arista/bugexposure.v1/services.gen_pb2_grpc.py depends on'
...
class BugExposureServiceServicer:
    """Missing associated documentation comment in .proto file."""
