...
class DeviceLifecycleSummaryService(object):
    ...
    def GetOne(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/arista.lifecycle.v1.DeviceLifecycleSummaryService/GetOne',
    ...
    def GetAll(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_stream(request, target, '/arista.lifecycle.v1.DeviceLifecycleSummaryService/GetAll',
    ...
    def Subscribe(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_stream(request, target, '/arista.lifecycle.v1.DeviceLifecycleSummaryService/Subscribe',
            arista_dot_lifecycle_dot_v1_dot_services_dot_gen__pb2.DeviceLifecycleSummaryStreamRequest.SerializeToString,
            arista_dot_lifecycle_dot_v1_dot_services_dot_gen__pb2.DeviceLifecycleSummaryStreamResponse.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
    ...
    def GetMeta(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/arista.lifecycle.v1.DeviceLifecycleSummaryService/GetMeta',
            arista_dot_lifecycle_dot_v1_dot_services_dot_gen__pb2.DeviceLifecycleSummaryStreamRequest.SerializeToString,
    ...
    def SubscribeMeta(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_stream(request, target, '/arista.lifecycle.v1.DeviceLifecycleSummaryService/SubscribeMeta',
            arista_dot_lifecycle_dot_v1_dot_services_dot_gen__pb2.DeviceLifecycleSummaryStreamRequest.SerializeToString,
            arista_dot_lifecycle_dot_v1_dot_services_dot_gen__pb2.MetaResponse.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
