...
if _version_not_supported:
    raise RuntimeError(
        ...
        + ' but the generated code in arista/endpointlocation.v1/services.gen_pb2_grpc.py depends on'
...
class EndpointLocationServiceStub:
...
class EndpointLocationServiceServicer:
    """Missing associated documentation comment in .proto file."""
