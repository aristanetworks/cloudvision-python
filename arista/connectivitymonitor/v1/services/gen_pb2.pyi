...
class ProbeRequest(google.protobuf.message.Message):
    ...
    def __init__(
        self,
        *,
        key: arista.connectivitymonitor.v1.connectivitymonitor_pb2.ProbeKey | None = ...,
        time: google.protobuf.timestamp_pb2.Timestamp | None = ...,
    ) -> None: ...
...
class ProbeResponse(google.protobuf.message.Message):
    ...
    def __init__(
        self,
        *,
        value: arista.connectivitymonitor.v1.connectivitymonitor_pb2.Probe | None = ...,
        time: google.protobuf.timestamp_pb2.Timestamp | None = ...,
    ) -> None: ...
...
class ProbeSomeRequest(google.protobuf.message.Message):
    ...
    def __init__(
        self,
        *,
        keys: collections.abc.Iterable[arista.connectivitymonitor.v1.connectivitymonitor_pb2.ProbeKey] | None = ...,
        time: google.protobuf.timestamp_pb2.Timestamp | None = ...,
    ) -> None: ...
...
class ProbeStreamRequest(google.protobuf.message.Message):
    ...
    def __init__(
        self,
        *,
        partial_eq_filter: collections.abc.Iterable[arista.connectivitymonitor.v1.connectivitymonitor_pb2.Probe] | None = ...,
...
class ProbeBatchedStreamResponse(google.protobuf.message.Message):
    ...
    def __init__(
        self,
        *,
        responses: collections.abc.Iterable[global___ProbeStreamResponse] | None = ...,
    ) -> None: ...
...
class ProbeStatsRequest(google.protobuf.message.Message):
    ...
    def __init__(
        self,
        *,
        key: arista.connectivitymonitor.v1.connectivitymonitor_pb2.ProbeStatsKey | None = ...,
        time: google.protobuf.timestamp_pb2.Timestamp | None = ...,
    ) -> None: ...
    def HasField(self, field_name: typing.Literal["key", b"key", "time", b"time"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["key", b"key", "time", b"time"]) -> None: ...
...
class ProbeStatsResponse(google.protobuf.message.Message):
    ...
    def __init__(
        self,
        *,
        value: arista.connectivitymonitor.v1.connectivitymonitor_pb2.ProbeStats | None = ...,
        time: google.protobuf.timestamp_pb2.Timestamp | None = ...,
    ) -> None: ...
    def HasField(self, field_name: typing.Literal["time", b"time", "value", b"value"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["time", b"time", "value", b"value"]) -> None: ...
...
class ProbeStatsSomeRequest(google.protobuf.message.Message):
    ...
    def __init__(
        self,
        *,
        keys: collections.abc.Iterable[arista.connectivitymonitor.v1.connectivitymonitor_pb2.ProbeStatsKey] | None = ...,
        time: google.protobuf.timestamp_pb2.Timestamp | None = ...,
    ) -> None: ...
    def HasField(self, field_name: typing.Literal["time", b"time"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["keys", b"keys", "time", b"time"]) -> None: ...
...
class ProbeStatsStreamRequest(google.protobuf.message.Message):
    ...
    def __init__(
        self,
        *,
        partial_eq_filter: collections.abc.Iterable[arista.connectivitymonitor.v1.connectivitymonitor_pb2.ProbeStats] | None = ...,
        time: arista.time.time_pb2.TimeBounds | None = ...,
    ) -> None: ...
    def HasField(self, field_name: typing.Literal["time", b"time"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["partial_eq_filter", b"partial_eq_filter", "time", b"time"]) -> None: ...
...
class ProbeStatsBatchedStreamResponse(google.protobuf.message.Message):
    ...
    def __init__(
        self,
        *,
        responses: collections.abc.Iterable[global___ProbeStatsStreamResponse] | None = ...,
    ) -> None: ...
    def ClearField(self, field_name: typing.Literal["responses", b"responses"]) -> None: ...
