...
class _ShardingFunctionEnumTypeWrapper(google.protobuf.internal.enum_type_wrapper._EnumTypeWrapper[_ShardingFunction.V], builtins.type):
    DESCRIPTOR: google.protobuf.descriptor.EnumDescriptor = ...
    DATASETANDPATH = ShardingFunction.V(0)
    """DATASETANDPATH shards by the association of dataset and path"""

    DATASET = ShardingFunction.V(1)
    """DATASET shards by dataset"""

    PATH = ShardingFunction.V(2)
    """PATH shards by path"""
...
class Sharding(google.protobuf.message.Message):
    ...
    shardingFunc: global___ShardingFunction.V = ...
