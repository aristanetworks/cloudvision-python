...
class TokenSelfRefreshConfigServiceBase(ServiceBase):
    ...
    async def get_one(
        self, token_self_refresh_config_request: "TokenSelfRefreshConfigRequest"
    ) -> "TokenSelfRefreshConfigResponse":
        """ """
    ...
    async def set(
        self, token_self_refresh_config_set_request: "TokenSelfRefreshConfigSetRequest"
    ) -> "TokenSelfRefreshConfigSetResponse":
        """ """
    ...
    async def __rpc_get_one(
        self,
        stream: "grpclib.server.Stream[TokenSelfRefreshConfigRequest, TokenSelfRefreshConfigResponse]",
    ) -> None:
        request = await stream.recv_message()
        response = await self.get_one(request)
        await stream.send_message(response)
    ...
    async def __rpc_get_all(
        self,
        stream: "grpclib.server.Stream[TokenSelfRefreshConfigStreamRequest, TokenSelfRefreshConfigStreamResponse]",
    ) -> None:
        request = await stream.recv_message()
        await self._call_rpc_handler_server_stream(
            self.get_all,
    ...
    async def __rpc_set(
        self,
        stream: "grpclib.server.Stream[TokenSelfRefreshConfigSetRequest, TokenSelfRefreshConfigSetResponse]",
    ) -> None:
        request = await stream.recv_message()
        response = await self.set(request)
        await stream.send_message(response)
