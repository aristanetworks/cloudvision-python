...
class ExportServiceBase(ServiceBase):
    ...
    async def get_some(
        self, export_some_request: "ExportSomeRequest"
    ) -> AsyncIterator[ExportSomeResponse]:
        """ """
    ...
    async def __rpc_get_some(
        self, stream: "grpclib.server.Stream[ExportSomeRequest, ExportSomeResponse]"
    ) -> None:
        request = await stream.recv_message()
    ...
    async def __rpc_get_meta(
        self, stream: "grpclib.server.Stream[ExportStreamRequest, MetaResponse]"
    ) -> None:
        request = await stream.recv_message()
...
class ExportConfigServiceBase(ServiceBase):
    ...
    async def get_some(
        self, export_config_some_request: "ExportConfigSomeRequest"
    ) -> AsyncIterator[ExportConfigSomeResponse]:
        """ """
    ...
    async def set_some(
        self, export_config_set_some_request: "ExportConfigSetSomeRequest"
    ) -> AsyncIterator[ExportConfigSetSomeResponse]:
        """ """
    ...
    async def delete_some(
        self, export_config_delete_some_request: "ExportConfigDeleteSomeRequest"
    ) -> AsyncIterator[ExportConfigDeleteSomeResponse]:
        """ """
    ...
    async def __rpc_get_meta(
        self, stream: "grpclib.server.Stream[ExportConfigStreamRequest, MetaResponse]"
    ) -> None:
        request = await stream.recv_message()
        response = await self.get_meta(request)
        await stream.send_message(response)
    ...
    async def __rpc_set_some(
        self,
        stream: "grpclib.server.Stream[ExportConfigSetSomeRequest, ExportConfigSetSomeResponse]",
    ) -> None:
        request = await stream.recv_message()
        await self._call_rpc_handler_server_stream(
            self.set_some,
    ...
    async def __rpc_delete_some(
        self,
        stream: "grpclib.server.Stream[ExportConfigDeleteSomeRequest, ExportConfigDeleteSomeResponse]",
    ) -> None:
        request = await stream.recv_message()
        await self._call_rpc_handler_server_stream(
            self.delete_some,
