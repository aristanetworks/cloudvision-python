...
class ApiProxyServiceBase(ServiceBase):
    ...
    async def __rpc_get_one(
        self, stream: "grpclib.server.Stream[ApiProxyRequest, ApiProxyResponse]"
    ) -> None:
    ...
    async def __rpc_subscribe_meta(
        self, stream: "grpclib.server.Stream[ApiProxyStreamRequest, MetaResponse]"
    ) -> None:
        request = await stream.recv_message()
        await self._call_rpc_handler_server_stream(
            self.subscribe_meta,
...
class ApiProxyConfigServiceBase(ServiceBase):
    ...
    async def __rpc_get_all(
        self,
        stream: "grpclib.server.Stream[ApiProxyConfigStreamRequest, ApiProxyConfigStreamResponse]",
    ) -> None:
        request = await stream.recv_message()
        await self._call_rpc_handler_server_stream(
            self.get_all,
    ...
    async def __rpc_subscribe_meta(
        self, stream: "grpclib.server.Stream[ApiProxyConfigStreamRequest, MetaResponse]"
    ) -> None:
        request = await stream.recv_message()
        await self._call_rpc_handler_server_stream(
            self.subscribe_meta,
    ...
    async def __rpc_delete(
        self,
        stream: "grpclib.server.Stream[ApiProxyConfigDeleteRequest, ApiProxyConfigDeleteResponse]",
    ) -> None:
        request = await stream.recv_message()
...
class ApiTokenServiceBase(ServiceBase):
    ...
    async def __rpc_get_one(
        self, stream: "grpclib.server.Stream[ApiTokenRequest, ApiTokenResponse]"
    ) -> None:
        request = await stream.recv_message()
        response = await self.get_one(request)
        await stream.send_message(response)
    ...
    async def __rpc_subscribe_meta(
        self, stream: "grpclib.server.Stream[ApiTokenStreamRequest, MetaResponse]"
    ) -> None:
        request = await stream.recv_message()
        await self._call_rpc_handler_server_stream(
            self.subscribe_meta,
...
class ApiTokenConfigServiceBase(ServiceBase):
    ...
    async def __rpc_get_all(
        self,
        stream: "grpclib.server.Stream[ApiTokenConfigStreamRequest, ApiTokenConfigStreamResponse]",
    ) -> None:
        request = await stream.recv_message()
        await self._call_rpc_handler_server_stream(
            self.get_all,
    ...
    async def __rpc_subscribe_meta(
        self, stream: "grpclib.server.Stream[ApiTokenConfigStreamRequest, MetaResponse]"
    ) -> None:
        request = await stream.recv_message()
        await self._call_rpc_handler_server_stream(
            self.subscribe_meta,
    ...
    async def __rpc_delete(
        self,
        stream: "grpclib.server.Stream[ApiTokenConfigDeleteRequest, ApiTokenConfigDeleteResponse]",
    ) -> None:
        request = await stream.recv_message()
        response = await self.delete(request)
        await stream.send_message(response)
