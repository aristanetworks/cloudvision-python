...
class PurchasedLicense(aristaproto.Message):
    ...
    original_subscription_record_number: Optional[int] = aristaproto.message_field(
        10, wraps=aristaproto.TYPE_INT64
    )
    """
    original_subscription_record_number is the parent subscription record number.
    """

    original_sales_order_number: Optional[int] = aristaproto.message_field(
        11, wraps=aristaproto.TYPE_INT64
    )
    ...
    end_customer_parent_account_id: Optional[int] = aristaproto.message_field(
        14, wraps=aristaproto.TYPE_INT64
    )
    """end_customer_parent_account_id is the parent company ID."""

    end_customer_parent_account_name: Optional[str] = aristaproto.message_field(
    ...
    end_customer_purchase_order_number: Optional[str] = aristaproto.message_field(
        17, wraps=aristaproto.TYPE_STRING
    )
    """
...
class DeviceLicenseStatus(aristaproto.Message):
    ...
    values: Dict[str, "LicenseStatus"] = aristaproto.map_field(
...
class Filter(aristaproto.Message):
    ...
    has_perpetual_license: Optional[bool] = aristaproto.message_field(
...
class LicenseBundle(aristaproto.Message):
    ...
    unassigned_license_count: Optional[int] = aristaproto.message_field(
        8, wraps=aristaproto.TYPE_UINT64
    )
    """
...
class ApplicableDevicesServiceBase(ServiceBase):
    async def get_one(
        self, applicable_devices_request: "ApplicableDevicesRequest"
    ) -> "ApplicableDevicesResponse":
        raise grpclib.GRPCError(grpclib.const.Status.UNIMPLEMENTED)

    async def get_some(
        self, applicable_devices_some_request: "ApplicableDevicesSomeRequest"
    ) -> AsyncIterator[ApplicableDevicesSomeResponse]:
        raise grpclib.GRPCError(grpclib.const.Status.UNIMPLEMENTED)
    ...
    async def __rpc_get_some(
        self,
        stream: "grpclib.server.Stream[ApplicableDevicesSomeRequest, ApplicableDevicesSomeResponse]",
    ) -> None:
        request = await stream.recv_message()
    ...
    async def __rpc_get_all(
        self,
        stream: "grpclib.server.Stream[ApplicableDevicesStreamRequest, ApplicableDevicesStreamResponse]",
    ) -> None:
        request = await stream.recv_message()
        await self._call_rpc_handler_server_stream(
            self.get_all,
    ...
    async def __rpc_get_all_batched(
        self,
        stream: "grpclib.server.Stream[ApplicableDevicesBatchedStreamRequest, ApplicableDevicesBatchedStreamResponse]",
    ) -> None:
        request = await stream.recv_message()
        await self._call_rpc_handler_server_stream(
...
class ApplicableLicenseBundlesServiceBase(ServiceBase):
    async def get_one(
        self, applicable_license_bundles_request: "ApplicableLicenseBundlesRequest"
    ) -> "ApplicableLicenseBundlesResponse":
        raise grpclib.GRPCError(grpclib.const.Status.UNIMPLEMENTED)
    ...
    async def __rpc_get_one(
        self,
        stream: "grpclib.server.Stream[ApplicableLicenseBundlesRequest, ApplicableLicenseBundlesResponse]",
    ) -> None:
        request = await stream.recv_message()
        response = await self.get_one(request)
        await stream.send_message(response)
    ...
    async def __rpc_get_some(
        self,
        stream: "grpclib.server.Stream[ApplicableLicenseBundlesSomeRequest, ApplicableLicenseBundlesSomeResponse]",
    ) -> None:
        request = await stream.recv_message()
        await self._call_rpc_handler_server_stream(
            self.get_some,
    ...
    async def __rpc_get_all(
        self,
        stream: "grpclib.server.Stream[ApplicableLicenseBundlesStreamRequest, ApplicableLicenseBundlesStreamResponse]",
    ) -> None:
        request = await stream.recv_message()
        await self._call_rpc_handler_server_stream(
            self.get_all,
    ...
    async def __rpc_get_all_batched(
        self,
        stream: "grpclib.server.Stream[ApplicableLicenseBundlesBatchedStreamRequest, ApplicableLicenseBundlesBatchedStreamResponse]",
    ) -> None:
        request = await stream.recv_message()
        await self._call_rpc_handler_server_stream(
            self.get_all_batched,
...
class LicenseAssignmentServiceBase(ServiceBase):
    async def get_one(
        self, license_assignment_request: "LicenseAssignmentRequest"
    ) -> "LicenseAssignmentResponse":
        raise grpclib.GRPCError(grpclib.const.Status.UNIMPLEMENTED)

    async def get_some(
        self, license_assignment_some_request: "LicenseAssignmentSomeRequest"
    ) -> AsyncIterator[LicenseAssignmentSomeResponse]:
        raise grpclib.GRPCError(grpclib.const.Status.UNIMPLEMENTED)

    async def get_all(
        self, license_assignment_stream_request: "LicenseAssignmentStreamRequest"
    ) -> AsyncIterator[LicenseAssignmentStreamResponse]:
        raise grpclib.GRPCError(grpclib.const.Status.UNIMPLEMENTED)
    ...
    async def __rpc_get_some(
        self,
        stream: "grpclib.server.Stream[LicenseAssignmentSomeRequest, LicenseAssignmentSomeResponse]",
    ) -> None:
        request = await stream.recv_message()
        await self._call_rpc_handler_server_stream(
            self.get_some,
    ...
    async def __rpc_get_all(
        self,
        stream: "grpclib.server.Stream[LicenseAssignmentStreamRequest, LicenseAssignmentStreamResponse]",
    ) -> None:
        request = await stream.recv_message()
        await self._call_rpc_handler_server_stream(
            self.get_all,
    ...
    async def __rpc_get_all_batched(
        self,
        stream: "grpclib.server.Stream[LicenseAssignmentBatchedStreamRequest, LicenseAssignmentBatchedStreamResponse]",
    ) -> None:
        request = await stream.recv_message()
        await self._call_rpc_handler_server_stream(
            self.get_all_batched,
...
class LicenseAssignmentConfigServiceBase(ServiceBase):
    async def get_one(
        self, license_assignment_config_request: "LicenseAssignmentConfigRequest"
    ) -> "LicenseAssignmentConfigResponse":
        raise grpclib.GRPCError(grpclib.const.Status.UNIMPLEMENTED)
    ...
    async def set(
        self, license_assignment_config_set_request: "LicenseAssignmentConfigSetRequest"
    ) -> "LicenseAssignmentConfigSetResponse":
        raise grpclib.GRPCError(grpclib.const.Status.UNIMPLEMENTED)
    ...
    async def __rpc_get_one(
        self,
        stream: "grpclib.server.Stream[LicenseAssignmentConfigRequest, LicenseAssignmentConfigResponse]",
    ) -> None:
        request = await stream.recv_message()
        response = await self.get_one(request)
        await stream.send_message(response)
    ...
    async def __rpc_get_some(
        self,
        stream: "grpclib.server.Stream[LicenseAssignmentConfigSomeRequest, LicenseAssignmentConfigSomeResponse]",
    ) -> None:
        request = await stream.recv_message()
        await self._call_rpc_handler_server_stream(
            self.get_some,
    ...
    async def __rpc_get_all(
        self,
        stream: "grpclib.server.Stream[LicenseAssignmentConfigStreamRequest, LicenseAssignmentConfigStreamResponse]",
    ) -> None:
        request = await stream.recv_message()
        await self._call_rpc_handler_server_stream(
            self.get_all,
    ...
    async def __rpc_set(
        self,
        stream: "grpclib.server.Stream[LicenseAssignmentConfigSetRequest, LicenseAssignmentConfigSetResponse]",
    ) -> None:
        request = await stream.recv_message()
    ...
    async def __rpc_set_some(
        self,
        stream: "grpclib.server.Stream[LicenseAssignmentConfigSetSomeRequest, LicenseAssignmentConfigSetSomeResponse]",
    ) -> None:
        request = await stream.recv_message()
        await self._call_rpc_handler_server_stream(
            self.set_some,
    ...
    async def __rpc_delete(
        self,
        stream: "grpclib.server.Stream[LicenseAssignmentConfigDeleteRequest, LicenseAssignmentConfigDeleteResponse]",
    ) -> None:
        request = await stream.recv_message()
    ...
    async def __rpc_delete_some(
        self,
        stream: "grpclib.server.Stream[LicenseAssignmentConfigDeleteSomeRequest, LicenseAssignmentConfigDeleteSomeResponse]",
    ) -> None:
        request = await stream.recv_message()
        await self._call_rpc_handler_server_stream(
            self.delete_some,
    ...
    async def __rpc_delete_all(
        self,
        stream: "grpclib.server.Stream[LicenseAssignmentConfigDeleteAllRequest, LicenseAssignmentConfigDeleteAllResponse]",
    ) -> None:
        request = await stream.recv_message()
        await self._call_rpc_handler_server_stream(
            self.delete_all,
    ...
    async def __rpc_get_all_batched(
        self,
        stream: "grpclib.server.Stream[LicenseAssignmentConfigBatchedStreamRequest, LicenseAssignmentConfigBatchedStreamResponse]",
    ) -> None:
        request = await stream.recv_message()
        await self._call_rpc_handler_server_stream(
            self.get_all_batched,
...
class LicenseFileServiceBase(ServiceBase):
    ...
    async def get_some(
        self, license_file_some_request: "LicenseFileSomeRequest"
    ) -> AsyncIterator[LicenseFileSomeResponse]:
        raise grpclib.GRPCError(grpclib.const.Status.UNIMPLEMENTED)

    async def get_all(
        self, license_file_stream_request: "LicenseFileStreamRequest"
    ) -> AsyncIterator[LicenseFileStreamResponse]:
        raise grpclib.GRPCError(grpclib.const.Status.UNIMPLEMENTED)
    ...
    async def __rpc_get_one(
        self, stream: "grpclib.server.Stream[LicenseFileRequest, LicenseFileResponse]"
    ) -> None:
        request = await stream.recv_message()
        response = await self.get_one(request)
        await stream.send_message(response)
    ...
    async def __rpc_get_meta(
        self, stream: "grpclib.server.Stream[LicenseFileStreamRequest, MetaResponse]"
    ) -> None:
        request = await stream.recv_message()
        response = await self.get_meta(request)
        await stream.send_message(response)
    ...
    async def __rpc_get_all_batched(
        self,
        stream: "grpclib.server.Stream[LicenseFileBatchedStreamRequest, LicenseFileBatchedStreamResponse]",
    ) -> None:
        request = await stream.recv_message()
        await self._call_rpc_handler_server_stream(
            self.get_all_batched,
...
class LicenseFileConfigServiceBase(ServiceBase):
    async def get_one(
        self, license_file_config_request: "LicenseFileConfigRequest"
    ) -> "LicenseFileConfigResponse":
        raise grpclib.GRPCError(grpclib.const.Status.UNIMPLEMENTED)

    async def get_some(
        self, license_file_config_some_request: "LicenseFileConfigSomeRequest"
    ) -> AsyncIterator[LicenseFileConfigSomeResponse]:
        raise grpclib.GRPCError(grpclib.const.Status.UNIMPLEMENTED)
    ...
    async def set(
        self, license_file_config_set_request: "LicenseFileConfigSetRequest"
    ) -> "LicenseFileConfigSetResponse":
        raise grpclib.GRPCError(grpclib.const.Status.UNIMPLEMENTED)

    async def set_some(
        self, license_file_config_set_some_request: "LicenseFileConfigSetSomeRequest"
    ) -> AsyncIterator[LicenseFileConfigSetSomeResponse]:
        raise grpclib.GRPCError(grpclib.const.Status.UNIMPLEMENTED)

    async def delete(
        self, license_file_config_delete_request: "LicenseFileConfigDeleteRequest"
    ) -> "LicenseFileConfigDeleteResponse":
        raise grpclib.GRPCError(grpclib.const.Status.UNIMPLEMENTED)
    ...
    async def __rpc_get_some(
        self,
        stream: "grpclib.server.Stream[LicenseFileConfigSomeRequest, LicenseFileConfigSomeResponse]",
    ) -> None:
        request = await stream.recv_message()
        await self._call_rpc_handler_server_stream(
            self.get_some,
    ...
    async def __rpc_get_all(
        self,
        stream: "grpclib.server.Stream[LicenseFileConfigStreamRequest, LicenseFileConfigStreamResponse]",
    ) -> None:
        request = await stream.recv_message()
        await self._call_rpc_handler_server_stream(
            self.get_all,
    ...
    async def __rpc_set(
        self,
        stream: "grpclib.server.Stream[LicenseFileConfigSetRequest, LicenseFileConfigSetResponse]",
    ) -> None:
        request = await stream.recv_message()
        response = await self.set(request)
        await stream.send_message(response)
    ...
    async def __rpc_set_some(
        self,
        stream: "grpclib.server.Stream[LicenseFileConfigSetSomeRequest, LicenseFileConfigSetSomeResponse]",
    ) -> None:
        request = await stream.recv_message()
        await self._call_rpc_handler_server_stream(
            self.set_some,
    ...
    async def __rpc_delete(
        self,
        stream: "grpclib.server.Stream[LicenseFileConfigDeleteRequest, LicenseFileConfigDeleteResponse]",
    ) -> None:
        request = await stream.recv_message()
        response = await self.delete(request)
        await stream.send_message(response)
    ...
    async def __rpc_delete_some(
        self,
        stream: "grpclib.server.Stream[LicenseFileConfigDeleteSomeRequest, LicenseFileConfigDeleteSomeResponse]",
    ) -> None:
        request = await stream.recv_message()
        await self._call_rpc_handler_server_stream(
            self.delete_some,
    ...
    async def __rpc_delete_all(
        self,
        stream: "grpclib.server.Stream[LicenseFileConfigDeleteAllRequest, LicenseFileConfigDeleteAllResponse]",
    ) -> None:
        request = await stream.recv_message()
        await self._call_rpc_handler_server_stream(
            self.delete_all,
    ...
    async def __rpc_get_all_batched(
        self,
        stream: "grpclib.server.Stream[LicenseFileConfigBatchedStreamRequest, LicenseFileConfigBatchedStreamResponse]",
    ) -> None:
        request = await stream.recv_message()
        await self._call_rpc_handler_server_stream(
            self.get_all_batched,
...
class PurchasedLicenseServiceBase(ServiceBase):
    async def get_one(
        self, purchased_license_request: "PurchasedLicenseRequest"
    ) -> "PurchasedLicenseResponse":
        raise grpclib.GRPCError(grpclib.const.Status.UNIMPLEMENTED)

    async def get_some(
        self, purchased_license_some_request: "PurchasedLicenseSomeRequest"
    ) -> AsyncIterator[PurchasedLicenseSomeResponse]:
        raise grpclib.GRPCError(grpclib.const.Status.UNIMPLEMENTED)
    ...
    async def __rpc_get_some(
        self,
        stream: "grpclib.server.Stream[PurchasedLicenseSomeRequest, PurchasedLicenseSomeResponse]",
    ) -> None:
        request = await stream.recv_message()
        await self._call_rpc_handler_server_stream(
            self.get_some,
    ...
    async def __rpc_get_all(
        self,
        stream: "grpclib.server.Stream[PurchasedLicenseStreamRequest, PurchasedLicenseStreamResponse]",
    ) -> None:
        request = await stream.recv_message()
        await self._call_rpc_handler_server_stream(
            self.get_all,
    ...
    async def __rpc_get_all_batched(
        self,
        stream: "grpclib.server.Stream[PurchasedLicenseBatchedStreamRequest, PurchasedLicenseBatchedStreamResponse]",
    ) -> None:
        request = await stream.recv_message()
        await self._call_rpc_handler_server_stream(
            self.get_all_batched,
