...
class Workspace(aristaproto.Message):
    ...
    exclude_network_provisioning: Optional[bool] = aristaproto.message_field(
        15, wraps=aristaproto.TYPE_BOOL
    )
    """
...
class ConfigValidationResult(aristaproto.Message):
    ...
    only_filter_inputs_changed: Optional[bool] = aristaproto.message_field(
...
class StudioGeneratedConfigurationServiceBase(ServiceBase):
    ...
    async def __rpc_get_one(
        self,
        stream: "grpclib.server.Stream[StudioGeneratedConfigurationRequest, StudioGeneratedConfigurationResponse]",
    ) -> None:
    ...
    async def __rpc_get_some(
        self,
        stream: "grpclib.server.Stream[StudioGeneratedConfigurationSomeRequest, StudioGeneratedConfigurationSomeResponse]",
    ) -> None:
        request = await stream.recv_message()
    ...
    async def __rpc_get_all(
        self,
        stream: "grpclib.server.Stream[StudioGeneratedConfigurationStreamRequest, StudioGeneratedConfigurationStreamResponse]",
    ) -> None:
        request = await stream.recv_message()
        await self._call_rpc_handler_server_stream(
            self.get_all,
    ...
    async def __rpc_get_meta(
        self,
        stream: "grpclib.server.Stream[StudioGeneratedConfigurationStreamRequest, MetaResponse]",
    ) -> None:
        request = await stream.recv_message()
    ...
    async def __rpc_get_all_batched(
        self,
        stream: "grpclib.server.Stream[StudioGeneratedConfigurationBatchedStreamRequest, StudioGeneratedConfigurationBatchedStreamResponse]",
    ) -> None:
        request = await stream.recv_message()
        await self._call_rpc_handler_server_stream(
...
class WorkspaceDiffsServiceBase(ServiceBase):
    ...
    async def __rpc_get_all(
        self,
        stream: "grpclib.server.Stream[WorkspaceDiffsStreamRequest, WorkspaceDiffsStreamResponse]",
    ) -> None:
        request = await stream.recv_message()
        await self._call_rpc_handler_server_stream(
            self.get_all,
    ...
    async def __rpc_get_meta(
        self, stream: "grpclib.server.Stream[WorkspaceDiffsStreamRequest, MetaResponse]"
    ) -> None:
        request = await stream.recv_message()
        response = await self.get_meta(request)
        await stream.send_message(response)
    ...
    async def __rpc_get_all_batched(
        self,
        stream: "grpclib.server.Stream[WorkspaceDiffsBatchedStreamRequest, WorkspaceDiffsBatchedStreamResponse]",
    ) -> None:
        request = await stream.recv_message()
        await self._call_rpc_handler_server_stream(
            self.get_all_batched,
...
class WorkspaceSyncConfigServiceBase(ServiceBase):
    ...
    async def __rpc_get_one(
        self,
        stream: "grpclib.server.Stream[WorkspaceSyncConfigRequest, WorkspaceSyncConfigResponse]",
    ) -> None:
        request = await stream.recv_message()
        response = await self.get_one(request)
        await stream.send_message(response)
    ...
    async def __rpc_get_some(
        self,
        stream: "grpclib.server.Stream[WorkspaceSyncConfigSomeRequest, WorkspaceSyncConfigSomeResponse]",
    ) -> None:
        request = await stream.recv_message()
        await self._call_rpc_handler_server_stream(
            self.get_some,
    ...
    async def __rpc_get_all(
        self,
        stream: "grpclib.server.Stream[WorkspaceSyncConfigStreamRequest, WorkspaceSyncConfigStreamResponse]",
    ) -> None:
        request = await stream.recv_message()
        await self._call_rpc_handler_server_stream(
            self.get_all,
    ...
    async def __rpc_set(
        self,
        stream: "grpclib.server.Stream[WorkspaceSyncConfigSetRequest, WorkspaceSyncConfigSetResponse]",
    ) -> None:
        request = await stream.recv_message()
        response = await self.set(request)
        await stream.send_message(response)
    ...
    async def __rpc_set_some(
        self,
        stream: "grpclib.server.Stream[WorkspaceSyncConfigSetSomeRequest, WorkspaceSyncConfigSetSomeResponse]",
    ) -> None:
        request = await stream.recv_message()
        await self._call_rpc_handler_server_stream(
            self.set_some,
    ...
    async def __rpc_delete(
        self,
        stream: "grpclib.server.Stream[WorkspaceSyncConfigDeleteRequest, WorkspaceSyncConfigDeleteResponse]",
    ) -> None:
        request = await stream.recv_message()
        response = await self.delete(request)
        await stream.send_message(response)
    ...
    async def __rpc_delete_some(
        self,
        stream: "grpclib.server.Stream[WorkspaceSyncConfigDeleteSomeRequest, WorkspaceSyncConfigDeleteSomeResponse]",
    ) -> None:
        request = await stream.recv_message()
        await self._call_rpc_handler_server_stream(
            self.delete_some,
    ...
    async def __rpc_delete_all(
        self,
        stream: "grpclib.server.Stream[WorkspaceSyncConfigDeleteAllRequest, WorkspaceSyncConfigDeleteAllResponse]",
    ) -> None:
        request = await stream.recv_message()
        await self._call_rpc_handler_server_stream(
            self.delete_all,
    ...
    async def __rpc_get_all_batched(
        self,
        stream: "grpclib.server.Stream[WorkspaceSyncConfigBatchedStreamRequest, WorkspaceSyncConfigBatchedStreamResponse]",
    ) -> None:
        request = await stream.recv_message()
        await self._call_rpc_handler_server_stream(
            self.get_all_batched,
