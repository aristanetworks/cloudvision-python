...
class RepeatedRepeatedString(google.protobuf.message.Message):
    """RepeatedRepeatedString wraps a repeated `cloudvision.fmp.RepeatedString`
    ...
    @property
    def values(self) -> google.protobuf.internal.containers.RepeatedCompositeFieldContainer[cloudvision.fmp.wrappers_pb2.RepeatedString]:
        """values is a list of `cloudvision.fmp.RepeatedString`."""
        pass
    def __init__(self,
        *,
        values: typing.Optional[typing.Iterable[cloudvision.fmp.wrappers_pb2.RepeatedString]] = ...,
        ) -> None: ...
...
class Action(google.protobuf.message.Message):
    ...
    def timeout(self) -> google.protobuf.wrappers_pb2.UInt32Value:
        ...
        pass
    @property
    def args(self) -> cloudvision.fmp.wrappers_pb2.MapStringString:
    ...
    def __init__(self,
        *,
        ...
        args: typing.Optional[cloudvision.fmp.wrappers_pb2.MapStringString] = ...,
        ) -> None: ...
...
class DeviceToStageMap(google.protobuf.message.Message):
    ...
    class ValuesEntry(google.protobuf.message.Message):
        ...
        key: typing.Text
        @property
        def value(self) -> cloudvision.fmp.wrappers_pb2.RepeatedString: ...
        def __init__(self,
            *,
            key: typing.Text = ...,
            value: typing.Optional[cloudvision.fmp.wrappers_pb2.RepeatedString] = ...,
            ) -> None: ...
        def HasField(self, field_name: typing_extensions.Literal["value",b"value"]) -> builtins.bool: ...
        def ClearField(self, field_name: typing_extensions.Literal["key",b"key","value",b"value"]) -> None: ...
    ...
    VALUES_FIELD_NUMBER: builtins.int
    @property
    def values(self) -> google.protobuf.internal.containers.MessageMap[typing.Text, cloudvision.fmp.wrappers_pb2.RepeatedString]:
    ...
    def __init__(self,
        *,
        values: typing.Optional[typing.Mapping[typing.Text, cloudvision.fmp.wrappers_pb2.RepeatedString]] = ...,
        ) -> None: ...
    def ClearField(self, field_name: typing_extensions.Literal["values",b"values"]) -> None: ...
