...
"""
import builtins
import cloudvision.arista.changecontrol.v1.changecontrol_pb2
...
class ApproveConfigRequest(google.protobuf.message.Message):
    ...
    TIME_FIELD_NUMBER: builtins.int
    @property
    def key(self) -> cloudvision.arista.changecontrol.v1.changecontrol_pb2.ChangeControlKey:
    ...
    def __init__(self,
        *,
        key: typing.Optional[cloudvision.arista.changecontrol.v1.changecontrol_pb2.ChangeControlKey] = ...,
        time: typing.Optional[google.protobuf.timestamp_pb2.Timestamp] = ...,
        ) -> None: ...
...
class ApproveConfigResponse(google.protobuf.message.Message):
    ...
    TIME_FIELD_NUMBER: builtins.int
    @property
    def value(self) -> cloudvision.arista.changecontrol.v1.changecontrol_pb2.ApproveConfig:
    ...
    def __init__(self,
        *,
        value: typing.Optional[cloudvision.arista.changecontrol.v1.changecontrol_pb2.ApproveConfig] = ...,
        time: typing.Optional[google.protobuf.timestamp_pb2.Timestamp] = ...,
        ) -> None: ...
...
class ApproveConfigSomeRequest(google.protobuf.message.Message):
    ...
    TIME_FIELD_NUMBER: builtins.int
    @property
    def keys(self) -> google.protobuf.internal.containers.RepeatedCompositeFieldContainer[cloudvision.arista.changecontrol.v1.changecontrol_pb2.ChangeControlKey]: ...
    @property
    def time(self) -> google.protobuf.timestamp_pb2.Timestamp:
        """Time indicates the time for which you are interested in the data.
        If no time is given, the server will use the time at which it makes the request.
    ...
    def __init__(self,
        *,
        keys: typing.Optional[typing.Iterable[cloudvision.arista.changecontrol.v1.changecontrol_pb2.ChangeControlKey]] = ...,
        time: typing.Optional[google.protobuf.timestamp_pb2.Timestamp] = ...,
        ) -> None: ...
...
class ApproveConfigStreamRequest(google.protobuf.message.Message):
    ...
    TIME_FIELD_NUMBER: builtins.int
    @property
    def partial_eq_filter(self) -> google.protobuf.internal.containers.RepeatedCompositeFieldContainer[cloudvision.arista.changecontrol.v1.changecontrol_pb2.ApproveConfig]:
    ...
    def __init__(self,
        *,
        partial_eq_filter: typing.Optional[typing.Iterable[cloudvision.arista.changecontrol.v1.changecontrol_pb2.ApproveConfig]] = ...,
...
class ApproveConfigSetSomeRequest(google.protobuf.message.Message):
    ...
    @property
    def values(self) -> google.protobuf.internal.containers.RepeatedCompositeFieldContainer[cloudvision.arista.changecontrol.v1.changecontrol_pb2.ApproveConfig]:
    ...
    def __init__(self,
        *,
        values: typing.Optional[typing.Iterable[cloudvision.arista.changecontrol.v1.changecontrol_pb2.ApproveConfig]] = ...,
        ) -> None: ...
...
class ChangeControlResponse(google.protobuf.message.Message):
    ...
    TIME_FIELD_NUMBER: builtins.int
    @property
    def value(self) -> cloudvision.arista.changecontrol.v1.changecontrol_pb2.ChangeControl:
        """Value is the value requested.
        This structure will be fully-populated as it exists in the datastore. If
        optional fields were not given at creation, these fields will be empty or
        set to default values.
    ...
    def __init__(self,
        *,
        value: typing.Optional[cloudvision.arista.changecontrol.v1.changecontrol_pb2.ChangeControl] = ...,
        time: typing.Optional[google.protobuf.timestamp_pb2.Timestamp] = ...,
        ) -> None: ...
    def HasField(self, field_name: typing_extensions.Literal["time",b"time","value",b"value"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["time",b"time","value",b"value"]) -> None: ...
...
class ChangeControlStreamRequest(google.protobuf.message.Message):
    ...
    TIME_FIELD_NUMBER: builtins.int
    @property
    def partial_eq_filter(self) -> google.protobuf.internal.containers.RepeatedCompositeFieldContainer[cloudvision.arista.changecontrol.v1.changecontrol_pb2.ChangeControl]:
        """PartialEqFilter provides a way to server-side filter a GetAll/Subscribe.
        This requires all provided fields to be equal to the response.
        ...
        pass
    @property
    def filter(self) -> cloudvision.arista.changecontrol.v1.changecontrol_pb2.Filter:
    ...
    def __init__(self,
        *,
        partial_eq_filter: typing.Optional[typing.Iterable[cloudvision.arista.changecontrol.v1.changecontrol_pb2.ChangeControl]] = ...,
        filter: typing.Optional[cloudvision.arista.changecontrol.v1.changecontrol_pb2.Filter] = ...,
        time: typing.Optional[cloudvision.arista.time.time_pb2.TimeBounds] = ...,
        ) -> None: ...
...
class ChangeControlConfigResponse(google.protobuf.message.Message):
    ...
    TIME_FIELD_NUMBER: builtins.int
    @property
    def value(self) -> cloudvision.arista.changecontrol.v1.changecontrol_pb2.ChangeControlConfig:
        """Value is the value requested.
        This structure will be fully-populated as it exists in the datastore. If
        optional fields were not given at creation, these fields will be empty or
        set to default values.
    ...
    def __init__(self,
        *,
        value: typing.Optional[cloudvision.arista.changecontrol.v1.changecontrol_pb2.ChangeControlConfig] = ...,
        time: typing.Optional[google.protobuf.timestamp_pb2.Timestamp] = ...,
        ) -> None: ...
    def HasField(self, field_name: typing_extensions.Literal["time",b"time","value",b"value"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["time",b"time","value",b"value"]) -> None: ...
...
class ChangeControlConfigStreamRequest(google.protobuf.message.Message):
    ...
    TIME_FIELD_NUMBER: builtins.int
    @property
    def partial_eq_filter(self) -> google.protobuf.internal.containers.RepeatedCompositeFieldContainer[cloudvision.arista.changecontrol.v1.changecontrol_pb2.ChangeControlConfig]:
        """PartialEqFilter provides a way to server-side filter a GetAll/Subscribe.
        This requires all provided fields to be equal to the response.
    ...
    def __init__(self,
        *,
        partial_eq_filter: typing.Optional[typing.Iterable[cloudvision.arista.changecontrol.v1.changecontrol_pb2.ChangeControlConfig]] = ...,
        time: typing.Optional[cloudvision.arista.time.time_pb2.TimeBounds] = ...,
        ) -> None: ...
    def HasField(self, field_name: typing_extensions.Literal["time",b"time"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["partial_eq_filter",b"partial_eq_filter","time",b"time"]) -> None: ...
...
class ChangeControlConfigSetSomeRequest(google.protobuf.message.Message):
    ...
    VALUES_FIELD_NUMBER: builtins.int
    @property
    def values(self) -> google.protobuf.internal.containers.RepeatedCompositeFieldContainer[cloudvision.arista.changecontrol.v1.changecontrol_pb2.ChangeControlConfig]:
    ...
    def __init__(self,
        *,
        values: typing.Optional[typing.Iterable[cloudvision.arista.changecontrol.v1.changecontrol_pb2.ChangeControlConfig]] = ...,
        ) -> None: ...
    def ClearField(self, field_name: typing_extensions.Literal["values",b"values"]) -> None: ...
