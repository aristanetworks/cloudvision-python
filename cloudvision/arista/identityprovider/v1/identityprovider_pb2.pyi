...
class OAuthConfig(google.protobuf.message.Message):
    ...
    def client_secret(self) -> google.protobuf.wrappers_pb2.StringValue:
        ...
        pass
    @property
    def algorithms(self) -> cloudvision.fmp.wrappers_pb2.RepeatedString:
    ...
    def jwks_uri(self) -> google.protobuf.wrappers_pb2.StringValue:
        ...
        pass
    @property
    def permitted_email_domains(self) -> cloudvision.fmp.wrappers_pb2.RepeatedString:
    ...
    def __init__(self,
        *,
        ...
        algorithms: typing.Optional[cloudvision.fmp.wrappers_pb2.RepeatedString] = ...,
        ...
        permitted_email_domains: typing.Optional[cloudvision.fmp.wrappers_pb2.RepeatedString] = ...,
