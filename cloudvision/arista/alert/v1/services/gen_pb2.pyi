...
"""
import builtins
import cloudvision.arista.alert.v1.alert_pb2
...
class AlertResponse(google.protobuf.message.Message):
    ...
    TIME_FIELD_NUMBER: builtins.int
    @property
    def value(self) -> cloudvision.arista.alert.v1.alert_pb2.Alert:
    ...
    def __init__(self,
        *,
        value: typing.Optional[cloudvision.arista.alert.v1.alert_pb2.Alert] = ...,
        time: typing.Optional[google.protobuf.timestamp_pb2.Timestamp] = ...,
        ) -> None: ...
...
class AlertConfigResponse(google.protobuf.message.Message):
    ...
    TIME_FIELD_NUMBER: builtins.int
    @property
    def value(self) -> cloudvision.arista.alert.v1.alert_pb2.AlertConfig:
        """Value is the value requested.
        This structure will be fully-populated as it exists in the datastore. If
        optional fields were not given at creation, these fields will be empty or
        set to default values.
    ...
    def __init__(self,
        *,
        value: typing.Optional[cloudvision.arista.alert.v1.alert_pb2.AlertConfig] = ...,
        time: typing.Optional[google.protobuf.timestamp_pb2.Timestamp] = ...,
        ) -> None: ...
    def HasField(self, field_name: typing_extensions.Literal["time",b"time","value",b"value"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["time",b"time","value",b"value"]) -> None: ...
...
class DefaultTemplateRequest(google.protobuf.message.Message):
    ...
    TIME_FIELD_NUMBER: builtins.int
    @property
    def key(self) -> cloudvision.arista.alert.v1.alert_pb2.TemplateKey:
    ...
    def __init__(self,
        *,
        key: typing.Optional[cloudvision.arista.alert.v1.alert_pb2.TemplateKey] = ...,
        time: typing.Optional[google.protobuf.timestamp_pb2.Timestamp] = ...,
        ) -> None: ...
...
class DefaultTemplateResponse(google.protobuf.message.Message):
    ...
    TIME_FIELD_NUMBER: builtins.int
    @property
    def value(self) -> cloudvision.arista.alert.v1.alert_pb2.DefaultTemplate:
        """Value is the value requested.
        This structure will be fully-populated as it exists in the datastore. If
        optional fields were not given at creation, these fields will be empty or
        set to default values.
    ...
    def __init__(self,
        *,
        value: typing.Optional[cloudvision.arista.alert.v1.alert_pb2.DefaultTemplate] = ...,
        time: typing.Optional[google.protobuf.timestamp_pb2.Timestamp] = ...,
        ) -> None: ...
    def HasField(self, field_name: typing_extensions.Literal["time",b"time","value",b"value"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["time",b"time","value",b"value"]) -> None: ...
...
class DefaultTemplateSomeRequest(google.protobuf.message.Message):
    ...
    TIME_FIELD_NUMBER: builtins.int
    @property
    def keys(self) -> google.protobuf.internal.containers.RepeatedCompositeFieldContainer[cloudvision.arista.alert.v1.alert_pb2.TemplateKey]: ...
    @property
    def time(self) -> google.protobuf.timestamp_pb2.Timestamp:
        """Time indicates the time for which you are interested in the data.
        If no time is given, the server will use the time at which it makes the request.
    ...
    def __init__(self,
        *,
        keys: typing.Optional[typing.Iterable[cloudvision.arista.alert.v1.alert_pb2.TemplateKey]] = ...,
        time: typing.Optional[google.protobuf.timestamp_pb2.Timestamp] = ...,
        ) -> None: ...
    def HasField(self, field_name: typing_extensions.Literal["time",b"time"]) -> builtins.bool: ...
...
class TemplateConfigResponse(google.protobuf.message.Message):
    ...
    TIME_FIELD_NUMBER: builtins.int
    @property
    def value(self) -> cloudvision.arista.alert.v1.alert_pb2.TemplateConfig:
        """Value is the value requested.
        This structure will be fully-populated as it exists in the datastore. If
        optional fields were not given at creation, these fields will be empty or
        set to default values.
    ...
    def __init__(self,
        *,
        value: typing.Optional[cloudvision.arista.alert.v1.alert_pb2.TemplateConfig] = ...,
        time: typing.Optional[google.protobuf.timestamp_pb2.Timestamp] = ...,
        ) -> None: ...
    def HasField(self, field_name: typing_extensions.Literal["time",b"time","value",b"value"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["time",b"time","value",b"value"]) -> None: ...
...
class TemplateConfigSetSomeRequest(google.protobuf.message.Message):
    ...
    @property
    def values(self) -> google.protobuf.internal.containers.RepeatedCompositeFieldContainer[cloudvision.arista.alert.v1.alert_pb2.TemplateConfig]:
    ...
    def __init__(self,
        *,
        values: typing.Optional[typing.Iterable[cloudvision.arista.alert.v1.alert_pb2.TemplateConfig]] = ...,
        ) -> None: ...
