...
"""
import builtins
import cloudvision.arista.redirector.v1.redirector_pb2
...
class AssignmentRequest(google.protobuf.message.Message):
    ...
    TIME_FIELD_NUMBER: builtins.int
    @property
    def key(self) -> cloudvision.arista.redirector.v1.redirector_pb2.AssignmentKey:
    ...
    def __init__(self,
        *,
        key: typing.Optional[cloudvision.arista.redirector.v1.redirector_pb2.AssignmentKey] = ...,
        time: typing.Optional[google.protobuf.timestamp_pb2.Timestamp] = ...,
        ) -> None: ...
...
class AssignmentResponse(google.protobuf.message.Message):
    ...
    TIME_FIELD_NUMBER: builtins.int
    @property
    def value(self) -> cloudvision.arista.redirector.v1.redirector_pb2.Assignment:
    ...
    def __init__(self,
        *,
        value: typing.Optional[cloudvision.arista.redirector.v1.redirector_pb2.Assignment] = ...,
        time: typing.Optional[google.protobuf.timestamp_pb2.Timestamp] = ...,
        ) -> None: ...
...
class AssignmentSomeRequest(google.protobuf.message.Message):
    ...
    TIME_FIELD_NUMBER: builtins.int
    @property
    def keys(self) -> google.protobuf.internal.containers.RepeatedCompositeFieldContainer[cloudvision.arista.redirector.v1.redirector_pb2.AssignmentKey]: ...
    @property
    def time(self) -> google.protobuf.timestamp_pb2.Timestamp:
        """Time indicates the time for which you are interested in the data.
        If no time is given, the server will use the time at which it makes the request.
    ...
    def __init__(self,
        *,
        keys: typing.Optional[typing.Iterable[cloudvision.arista.redirector.v1.redirector_pb2.AssignmentKey]] = ...,
        time: typing.Optional[google.protobuf.timestamp_pb2.Timestamp] = ...,
        ) -> None: ...
...
class AssignmentStreamRequest(google.protobuf.message.Message):
    ...
    TIME_FIELD_NUMBER: builtins.int
    @property
    def partial_eq_filter(self) -> google.protobuf.internal.containers.RepeatedCompositeFieldContainer[cloudvision.arista.redirector.v1.redirector_pb2.Assignment]:
    ...
    def __init__(self,
        *,
        partial_eq_filter: typing.Optional[typing.Iterable[cloudvision.arista.redirector.v1.redirector_pb2.Assignment]] = ...,
...
class AssignmentBatchedStreamResponse(google.protobuf.message.Message):
    ...
    def __init__(self,
        *,
        responses: typing.Optional[typing.Iterable[global___AssignmentStreamResponse]] = ...,
        ) -> None: ...
