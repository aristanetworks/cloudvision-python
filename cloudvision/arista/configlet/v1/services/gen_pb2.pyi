...
"""
import builtins
import cloudvision.arista.configlet.v1.configlet_pb2
...
class ConfigletRequest(google.protobuf.message.Message):
    ...
    TIME_FIELD_NUMBER: builtins.int
    @property
    def key(self) -> cloudvision.arista.configlet.v1.configlet_pb2.ConfigletKey:
    ...
    def __init__(self,
        *,
        key: typing.Optional[cloudvision.arista.configlet.v1.configlet_pb2.ConfigletKey] = ...,
        time: typing.Optional[google.protobuf.timestamp_pb2.Timestamp] = ...,
        ) -> None: ...
...
class ConfigletResponse(google.protobuf.message.Message):
    ...
    TIME_FIELD_NUMBER: builtins.int
    @property
    def value(self) -> cloudvision.arista.configlet.v1.configlet_pb2.Configlet:
    ...
    def __init__(self,
        *,
        value: typing.Optional[cloudvision.arista.configlet.v1.configlet_pb2.Configlet] = ...,
        time: typing.Optional[google.protobuf.timestamp_pb2.Timestamp] = ...,
        ) -> None: ...
...
class ConfigletSomeRequest(google.protobuf.message.Message):
    ...
    TIME_FIELD_NUMBER: builtins.int
    @property
    def keys(self) -> google.protobuf.internal.containers.RepeatedCompositeFieldContainer[cloudvision.arista.configlet.v1.configlet_pb2.ConfigletKey]: ...
    @property
    def time(self) -> google.protobuf.timestamp_pb2.Timestamp:
        """Time indicates the time for which you are interested in the data.
        If no time is given, the server will use the time at which it makes the request.
    ...
    def __init__(self,
        *,
        keys: typing.Optional[typing.Iterable[cloudvision.arista.configlet.v1.configlet_pb2.ConfigletKey]] = ...,
        time: typing.Optional[google.protobuf.timestamp_pb2.Timestamp] = ...,
        ) -> None: ...
...
class ConfigletStreamRequest(google.protobuf.message.Message):
    ...
    TIME_FIELD_NUMBER: builtins.int
    @property
    def partial_eq_filter(self) -> google.protobuf.internal.containers.RepeatedCompositeFieldContainer[cloudvision.arista.configlet.v1.configlet_pb2.Configlet]:
        ...
        pass
    @property
    def filter(self) -> cloudvision.arista.configlet.v1.configlet_pb2.Filter:
    ...
    def __init__(self,
        *,
        partial_eq_filter: typing.Optional[typing.Iterable[cloudvision.arista.configlet.v1.configlet_pb2.Configlet]] = ...,
        filter: typing.Optional[cloudvision.arista.configlet.v1.configlet_pb2.Filter] = ...,
...
class ConfigletAssignmentRequest(google.protobuf.message.Message):
    ...
    TIME_FIELD_NUMBER: builtins.int
    @property
    def key(self) -> cloudvision.arista.configlet.v1.configlet_pb2.ConfigletAssignmentKey:
    ...
    def __init__(self,
        *,
        key: typing.Optional[cloudvision.arista.configlet.v1.configlet_pb2.ConfigletAssignmentKey] = ...,
        time: typing.Optional[google.protobuf.timestamp_pb2.Timestamp] = ...,
        ) -> None: ...
    def HasField(self, field_name: typing_extensions.Literal["key",b"key","time",b"time"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["key",b"key","time",b"time"]) -> None: ...
...
class ConfigletAssignmentResponse(google.protobuf.message.Message):
    ...
    TIME_FIELD_NUMBER: builtins.int
    @property
    def value(self) -> cloudvision.arista.configlet.v1.configlet_pb2.ConfigletAssignment:
        """Value is the value requested.
        This structure will be fully-populated as it exists in the datastore. If
        optional fields were not given at creation, these fields will be empty or
        set to default values.
    ...
    def __init__(self,
        *,
        value: typing.Optional[cloudvision.arista.configlet.v1.configlet_pb2.ConfigletAssignment] = ...,
        time: typing.Optional[google.protobuf.timestamp_pb2.Timestamp] = ...,
        ) -> None: ...
    def HasField(self, field_name: typing_extensions.Literal["time",b"time","value",b"value"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["time",b"time","value",b"value"]) -> None: ...
...
class ConfigletAssignmentSomeRequest(google.protobuf.message.Message):
    ...
    TIME_FIELD_NUMBER: builtins.int
    @property
    def keys(self) -> google.protobuf.internal.containers.RepeatedCompositeFieldContainer[cloudvision.arista.configlet.v1.configlet_pb2.ConfigletAssignmentKey]: ...
    @property
    def time(self) -> google.protobuf.timestamp_pb2.Timestamp:
        """Time indicates the time for which you are interested in the data.
        If no time is given, the server will use the time at which it makes the request.
    ...
    def __init__(self,
        *,
        keys: typing.Optional[typing.Iterable[cloudvision.arista.configlet.v1.configlet_pb2.ConfigletAssignmentKey]] = ...,
        time: typing.Optional[google.protobuf.timestamp_pb2.Timestamp] = ...,
        ) -> None: ...
    def HasField(self, field_name: typing_extensions.Literal["time",b"time"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["keys",b"keys","time",b"time"]) -> None: ...
...
class ConfigletAssignmentStreamRequest(google.protobuf.message.Message):
    ...
    TIME_FIELD_NUMBER: builtins.int
    @property
    def partial_eq_filter(self) -> google.protobuf.internal.containers.RepeatedCompositeFieldContainer[cloudvision.arista.configlet.v1.configlet_pb2.ConfigletAssignment]:
        """PartialEqFilter provides a way to server-side filter a GetAll/Subscribe.
        This requires all provided fields to be equal to the response.
    ...
    def __init__(self,
        *,
        partial_eq_filter: typing.Optional[typing.Iterable[cloudvision.arista.configlet.v1.configlet_pb2.ConfigletAssignment]] = ...,
        time: typing.Optional[cloudvision.arista.time.time_pb2.TimeBounds] = ...,
        ) -> None: ...
    def HasField(self, field_name: typing_extensions.Literal["time",b"time"]) -> builtins.bool: ...
...
class ConfigletAssignmentConfigResponse(google.protobuf.message.Message):
    ...
    TIME_FIELD_NUMBER: builtins.int
    @property
    def value(self) -> cloudvision.arista.configlet.v1.configlet_pb2.ConfigletAssignmentConfig:
        """Value is the value requested.
        This structure will be fully-populated as it exists in the datastore. If
        optional fields were not given at creation, these fields will be empty or
        set to default values.
    ...
    def __init__(self,
        *,
        value: typing.Optional[cloudvision.arista.configlet.v1.configlet_pb2.ConfigletAssignmentConfig] = ...,
        time: typing.Optional[google.protobuf.timestamp_pb2.Timestamp] = ...,
        ) -> None: ...
    def HasField(self, field_name: typing_extensions.Literal["time",b"time","value",b"value"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["time",b"time","value",b"value"]) -> None: ...
...
class ConfigletAssignmentConfigStreamRequest(google.protobuf.message.Message):
    ...
    TIME_FIELD_NUMBER: builtins.int
    @property
    def partial_eq_filter(self) -> google.protobuf.internal.containers.RepeatedCompositeFieldContainer[cloudvision.arista.configlet.v1.configlet_pb2.ConfigletAssignmentConfig]:
        """PartialEqFilter provides a way to server-side filter a GetAll/Subscribe.
        This requires all provided fields to be equal to the response.
    ...
    def __init__(self,
        *,
        partial_eq_filter: typing.Optional[typing.Iterable[cloudvision.arista.configlet.v1.configlet_pb2.ConfigletAssignmentConfig]] = ...,
        time: typing.Optional[cloudvision.arista.time.time_pb2.TimeBounds] = ...,
        ) -> None: ...
    def HasField(self, field_name: typing_extensions.Literal["time",b"time"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["partial_eq_filter",b"partial_eq_filter","time",b"time"]) -> None: ...
...
class ConfigletAssignmentConfigSetSomeRequest(google.protobuf.message.Message):
    ...
    @property
    def values(self) -> google.protobuf.internal.containers.RepeatedCompositeFieldContainer[cloudvision.arista.configlet.v1.configlet_pb2.ConfigletAssignmentConfig]:
    ...
    def __init__(self,
        *,
        values: typing.Optional[typing.Iterable[cloudvision.arista.configlet.v1.configlet_pb2.ConfigletAssignmentConfig]] = ...,
        ) -> None: ...
...
class ConfigletConfigResponse(google.protobuf.message.Message):
    ...
    TIME_FIELD_NUMBER: builtins.int
    @property
    def value(self) -> cloudvision.arista.configlet.v1.configlet_pb2.ConfigletConfig:
        """Value is the value requested.
        This structure will be fully-populated as it exists in the datastore. If
        optional fields were not given at creation, these fields will be empty or
        set to default values.
    ...
    def __init__(self,
        *,
        value: typing.Optional[cloudvision.arista.configlet.v1.configlet_pb2.ConfigletConfig] = ...,
        time: typing.Optional[google.protobuf.timestamp_pb2.Timestamp] = ...,
        ) -> None: ...
    def HasField(self, field_name: typing_extensions.Literal["time",b"time","value",b"value"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["time",b"time","value",b"value"]) -> None: ...
...
class ConfigletConfigStreamRequest(google.protobuf.message.Message):
    ...
    TIME_FIELD_NUMBER: builtins.int
    @property
    def partial_eq_filter(self) -> google.protobuf.internal.containers.RepeatedCompositeFieldContainer[cloudvision.arista.configlet.v1.configlet_pb2.ConfigletConfig]:
        """PartialEqFilter provides a way to server-side filter a GetAll/Subscribe.
        This requires all provided fields to be equal to the response.
    ...
    def __init__(self,
        *,
        partial_eq_filter: typing.Optional[typing.Iterable[cloudvision.arista.configlet.v1.configlet_pb2.ConfigletConfig]] = ...,
        filter: typing.Optional[cloudvision.arista.configlet.v1.configlet_pb2.Filter] = ...,
        time: typing.Optional[cloudvision.arista.time.time_pb2.TimeBounds] = ...,
        ) -> None: ...
    def HasField(self, field_name: typing_extensions.Literal["filter",b"filter","time",b"time"]) -> builtins.bool: ...
...
class ConfigletConfigSetSomeRequest(google.protobuf.message.Message):
    ...
    VALUES_FIELD_NUMBER: builtins.int
    @property
    def values(self) -> google.protobuf.internal.containers.RepeatedCompositeFieldContainer[cloudvision.arista.configlet.v1.configlet_pb2.ConfigletConfig]:
    ...
    def __init__(self,
        *,
        values: typing.Optional[typing.Iterable[cloudvision.arista.configlet.v1.configlet_pb2.ConfigletConfig]] = ...,
        ) -> None: ...
    def ClearField(self, field_name: typing_extensions.Literal["values",b"values"]) -> None: ...
