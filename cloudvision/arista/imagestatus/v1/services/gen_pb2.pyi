...
class SummaryRequest(google.protobuf.message.Message):
    ...
    TIME_FIELD_NUMBER: builtins.int
    @property
    def key(self) -> cloudvision.arista.imagestatus.v1.imagestatus_pb2.SummaryKey:
    ...
    def __init__(self,
        *,
        key: typing.Optional[cloudvision.arista.imagestatus.v1.imagestatus_pb2.SummaryKey] = ...,
        time: typing.Optional[google.protobuf.timestamp_pb2.Timestamp] = ...,
        ) -> None: ...
...
class SummaryResponse(google.protobuf.message.Message):
    ...
    TIME_FIELD_NUMBER: builtins.int
    @property
    def value(self) -> cloudvision.arista.imagestatus.v1.imagestatus_pb2.Summary:
    ...
    def __init__(self,
        *,
        value: typing.Optional[cloudvision.arista.imagestatus.v1.imagestatus_pb2.Summary] = ...,
        time: typing.Optional[google.protobuf.timestamp_pb2.Timestamp] = ...,
        ) -> None: ...
...
class SummarySomeRequest(google.protobuf.message.Message):
    ...
    TIME_FIELD_NUMBER: builtins.int
    @property
    def keys(self) -> google.protobuf.internal.containers.RepeatedCompositeFieldContainer[cloudvision.arista.imagestatus.v1.imagestatus_pb2.SummaryKey]: ...
    @property
    def time(self) -> google.protobuf.timestamp_pb2.Timestamp:
        """Time indicates the time for which you are interested in the data.
        If no time is given, the server will use the time at which it makes the request.
    ...
    def __init__(self,
        *,
        keys: typing.Optional[typing.Iterable[cloudvision.arista.imagestatus.v1.imagestatus_pb2.SummaryKey]] = ...,
        time: typing.Optional[google.protobuf.timestamp_pb2.Timestamp] = ...,
        ) -> None: ...
...
class SummaryStreamRequest(google.protobuf.message.Message):
    ...
    TIME_FIELD_NUMBER: builtins.int
    @property
    def partial_eq_filter(self) -> google.protobuf.internal.containers.RepeatedCompositeFieldContainer[cloudvision.arista.imagestatus.v1.imagestatus_pb2.Summary]:
    ...
    def __init__(self,
        *,
        partial_eq_filter: typing.Optional[typing.Iterable[cloudvision.arista.imagestatus.v1.imagestatus_pb2.Summary]] = ...,
