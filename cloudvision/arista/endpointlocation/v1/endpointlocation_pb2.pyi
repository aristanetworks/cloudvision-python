...
class IdentifierSourceList(google.protobuf.message.Message):
    ...
    def __init__(self,
        *,
        values: typing.Optional[typing.Iterable[global___IdentifierSource.ValueType]] = ...,
        ) -> None: ...
...
class Identifier(google.protobuf.message.Message):
    ...
    def __init__(self,
        *,
        ...
        source_list: typing.Optional[global___IdentifierSourceList] = ...,
        ) -> None: ...
    def HasField(self, field_name: typing_extensions.Literal["source_list",b"source_list","value",b"value"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["source_list",b"source_list","type",b"type","value",b"value"]) -> None: ...
...
class IdentifierList(google.protobuf.message.Message):
    ...
    def __init__(self,
        *,
        values: typing.Optional[typing.Iterable[global___Identifier]] = ...,
        ) -> None: ...
    def ClearField(self, field_name: typing_extensions.Literal["values",b"values"]) -> None: ...
...
class ExplanationList(google.protobuf.message.Message):
    ...
    def __init__(self,
        *,
        values: typing.Optional[typing.Iterable[global___Explanation.ValueType]] = ...,
        ) -> None: ...
    def ClearField(self, field_name: typing_extensions.Literal["values",b"values"]) -> None: ...
...
class Location(google.protobuf.message.Message):
    ...
    def __init__(self,
        *,
        ...
        device_status: global___DeviceStatus.ValueType = ...,
        interface: typing.Optional[google.protobuf.wrappers_pb2.StringValue] = ...,
        vlan_id: typing.Optional[google.protobuf.wrappers_pb2.UInt32Value] = ...,
        learned_time: typing.Optional[google.protobuf.timestamp_pb2.Timestamp] = ...,
        mac_type: global___MacType.ValueType = ...,
        likelihood: global___Likelihood.ValueType = ...,
        explanation_list: typing.Optional[global___ExplanationList] = ...,
        identifier_list: typing.Optional[global___IdentifierList] = ...,
        ) -> None: ...
    def HasField(self, field_name: typing_extensions.Literal["device_id",b"device_id","explanation_list",b"explanation_list","identifier_list",b"identifier_list","interface",b"interface","learned_time",b"learned_time","vlan_id",b"vlan_id"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["device_id",b"device_id","device_status",b"device_status","explanation_list",b"explanation_list","identifier_list",b"identifier_list","interface",b"interface","learned_time",b"learned_time","likelihood",b"likelihood","mac_type",b"mac_type","vlan_id",b"vlan_id"]) -> None: ...
...
class LocationList(google.protobuf.message.Message):
    ...
    def __init__(self,
        *,
        values: typing.Optional[typing.Iterable[global___Location]] = ...,
        ) -> None: ...
    def ClearField(self, field_name: typing_extensions.Literal["values",b"values"]) -> None: ...
...
class DeviceInfo(google.protobuf.message.Message):
    ...
    def classification(self) -> google.protobuf.wrappers_pb2.StringValue:
        ...
        pass
    @property
    def hierarchy(self) -> cloudvision.fmp.wrappers_pb2.RepeatedString:
    ...
    def __init__(self,
        *,
        device_name: typing.Optional[google.protobuf.wrappers_pb2.StringValue] = ...,
        mobile: typing.Optional[google.protobuf.wrappers_pb2.BoolValue] = ...,
        tablet: typing.Optional[google.protobuf.wrappers_pb2.BoolValue] = ...,
        score: typing.Optional[google.protobuf.wrappers_pb2.UInt32Value] = ...,
        version: typing.Optional[google.protobuf.wrappers_pb2.StringValue] = ...,
        mac_vendor: typing.Optional[google.protobuf.wrappers_pb2.StringValue] = ...,
        classification: typing.Optional[google.protobuf.wrappers_pb2.StringValue] = ...,
        hierarchy: typing.Optional[cloudvision.fmp.wrappers_pb2.RepeatedString] = ...,
        ) -> None: ...
    def HasField(self, field_name: typing_extensions.Literal["classification",b"classification","device_name",b"device_name","hierarchy",b"hierarchy","mac_vendor",b"mac_vendor","mobile",b"mobile","score",b"score","tablet",b"tablet","version",b"version"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["classification",b"classification","device_name",b"device_name","hierarchy",b"hierarchy","mac_vendor",b"mac_vendor","mobile",b"mobile","score",b"score","tablet",b"tablet","version",b"version"]) -> None: ...
...
class Device(google.protobuf.message.Message):
    ...
    def __init__(self,
        *,
        identifier_list: typing.Optional[global___IdentifierList] = ...,
        device_type: global___DeviceType.ValueType = ...,
        location_list: typing.Optional[global___LocationList] = ...,
        device_status: global___DeviceStatus.ValueType = ...,
        device_info: typing.Optional[global___DeviceInfo] = ...,
        ) -> None: ...
    def HasField(self, field_name: typing_extensions.Literal["device_info",b"device_info","identifier_list",b"identifier_list","location_list",b"location_list"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["device_info",b"device_info","device_status",b"device_status","device_type",b"device_type","identifier_list",b"identifier_list","location_list",b"location_list"]) -> None: ...
...
class DeviceMap(google.protobuf.message.Message):
    ...
    VALUES_FIELD_NUMBER: builtins.int
    @property
    def values(self) -> google.protobuf.internal.containers.MessageMap[typing.Text, global___Device]:
    ...
    def __init__(self,
        *,
        values: typing.Optional[typing.Mapping[typing.Text, global___Device]] = ...,
        ) -> None: ...
    def ClearField(self, field_name: typing_extensions.Literal["values",b"values"]) -> None: ...
...
class EndpointLocationKey(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["search_term",b"search_term"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["search_term",b"search_term"]) -> None: ...
...
class EndpointLocation(google.protobuf.message.Message):
    ...
    def __init__(self,
        *,
        key: typing.Optional[global___EndpointLocationKey] = ...,
        device_map: typing.Optional[global___DeviceMap] = ...,
        ) -> None: ...
    def HasField(self, field_name: typing_extensions.Literal["device_map",b"device_map","key",b"key"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["device_map",b"device_map","key",b"key"]) -> None: ...
