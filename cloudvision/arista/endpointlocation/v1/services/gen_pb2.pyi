...
"""
import builtins
import cloudvision.arista.endpointlocation.v1.endpointlocation_pb2
...
class EndpointLocationRequest(google.protobuf.message.Message):
    ...
    TIME_FIELD_NUMBER: builtins.int
    @property
    def key(self) -> cloudvision.arista.endpointlocation.v1.endpointlocation_pb2.EndpointLocationKey:
    ...
    def __init__(self,
        *,
        key: typing.Optional[cloudvision.arista.endpointlocation.v1.endpointlocation_pb2.EndpointLocationKey] = ...,
        time: typing.Optional[google.protobuf.timestamp_pb2.Timestamp] = ...,
        ) -> None: ...
...
class EndpointLocationResponse(google.protobuf.message.Message):
    ...
    TIME_FIELD_NUMBER: builtins.int
    @property
    def value(self) -> cloudvision.arista.endpointlocation.v1.endpointlocation_pb2.EndpointLocation:
    ...
    def __init__(self,
        *,
        value: typing.Optional[cloudvision.arista.endpointlocation.v1.endpointlocation_pb2.EndpointLocation] = ...,
        time: typing.Optional[google.protobuf.timestamp_pb2.Timestamp] = ...,
        ) -> None: ...
...
class EndpointLocationSomeRequest(google.protobuf.message.Message):
    ...
    TIME_FIELD_NUMBER: builtins.int
    @property
    def keys(self) -> google.protobuf.internal.containers.RepeatedCompositeFieldContainer[cloudvision.arista.endpointlocation.v1.endpointlocation_pb2.EndpointLocationKey]: ...
    @property
    def time(self) -> google.protobuf.timestamp_pb2.Timestamp:
        """Time indicates the time for which you are interested in the data.
        If no time is given, the server will use the time at which it makes the request.
    ...
    def __init__(self,
        *,
        keys: typing.Optional[typing.Iterable[cloudvision.arista.endpointlocation.v1.endpointlocation_pb2.EndpointLocationKey]] = ...,
        time: typing.Optional[google.protobuf.timestamp_pb2.Timestamp] = ...,
        ) -> None: ...
...
class EndpointLocationStreamRequest(google.protobuf.message.Message):
    ...
    TIME_FIELD_NUMBER: builtins.int
    @property
    def partial_eq_filter(self) -> google.protobuf.internal.containers.RepeatedCompositeFieldContainer[cloudvision.arista.endpointlocation.v1.endpointlocation_pb2.EndpointLocation]:
    ...
    def __init__(self,
        *,
        partial_eq_filter: typing.Optional[typing.Iterable[cloudvision.arista.endpointlocation.v1.endpointlocation_pb2.EndpointLocation]] = ...,
