...
"""
import builtins
import cloudvision.arista.configstatus.v1.configstatus_pb2
import cloudvision.arista.imagestatus.v1.imagestatus_pb2
...
class Workspace(google.protobuf.message.Message):
    ...
    def responses(self) -> global___Responses:
        ...
        pass
    @property
    def cc_ids(self) -> cloudvision.fmp.wrappers_pb2.RepeatedString:
    ...
    def __init__(self,
        *,
        ...
        cc_ids: typing.Optional[cloudvision.fmp.wrappers_pb2.RepeatedString] = ...,
...
class InputError(google.protobuf.message.Message):
    ...
    def field_id(self) -> google.protobuf.wrappers_pb2.StringValue:
        ...
        pass
    @property
    def path(self) -> cloudvision.fmp.wrappers_pb2.RepeatedString:
        """path is the path leading up to the input field."""
        pass
    @property
    def members(self) -> cloudvision.fmp.wrappers_pb2.RepeatedString:
    ...
    def __init__(self,
        *,
        ...
        path: typing.Optional[cloudvision.fmp.wrappers_pb2.RepeatedString] = ...,
        members: typing.Optional[cloudvision.fmp.wrappers_pb2.RepeatedString] = ...,
        message: typing.Optional[google.protobuf.wrappers_pb2.StringValue] = ...,
        ) -> None: ...
...
class InputValidationResult(google.protobuf.message.Message):
    ...
    def input_value_errors(self) -> global___InputErrors:
        ...
        pass
    @property
    def other_errors(self) -> cloudvision.fmp.wrappers_pb2.RepeatedString:
    ...
    def __init__(self,
        *,
        ...
        other_errors: typing.Optional[cloudvision.fmp.wrappers_pb2.RepeatedString] = ...,
...
class ConfigValidationResult(google.protobuf.message.Message):
    ...
    @property
    def summary(self) -> cloudvision.arista.configstatus.v1.configstatus_pb2.ConfigSummary:
        """summary is a summary of the changes to the previous config."""
        pass
    @property
    def errors(self) -> cloudvision.arista.configstatus.v1.configstatus_pb2.ConfigErrors:
        """errors are any errors detected in the generated config."""
        pass
    @property
    def warnings(self) -> cloudvision.arista.configstatus.v1.configstatus_pb2.ConfigErrors:
        """warnings are any warnings about the generated config."""
        pass
    @property
    def config_sources(self) -> cloudvision.arista.configstatus.v1.configstatus_pb2.ConfigSources:
        """config_sources identify the entities that generated the config."""
        pass
    def __init__(self,
        *,
        summary: typing.Optional[cloudvision.arista.configstatus.v1.configstatus_pb2.ConfigSummary] = ...,
        errors: typing.Optional[cloudvision.arista.configstatus.v1.configstatus_pb2.ConfigErrors] = ...,
        warnings: typing.Optional[cloudvision.arista.configstatus.v1.configstatus_pb2.ConfigErrors] = ...,
        config_sources: typing.Optional[cloudvision.arista.configstatus.v1.configstatus_pb2.ConfigSources] = ...,
        ) -> None: ...
...
class ImageValidationResult(google.protobuf.message.Message):
    ...
    @property
    def summary(self) -> cloudvision.arista.imagestatus.v1.imagestatus_pb2.ImageSummary:
        """summary is a summary of the changes to the previous image."""
        pass
    @property
    def errors(self) -> cloudvision.arista.imagestatus.v1.imagestatus_pb2.ImageErrors:
        """errors are any errors detected in the generated image."""
        pass
    @property
    def warnings(self) -> cloudvision.arista.imagestatus.v1.imagestatus_pb2.ImageWarnings:
    ...
    def image_input_error(self) -> google.protobuf.wrappers_pb2.StringValue:
        ...
        pass
    @property
    def infos(self) -> cloudvision.arista.imagestatus.v1.imagestatus_pb2.ImageInfos:
        """infos are any info messages about the generated image."""
        pass
    def __init__(self,
        *,
        summary: typing.Optional[cloudvision.arista.imagestatus.v1.imagestatus_pb2.ImageSummary] = ...,
        errors: typing.Optional[cloudvision.arista.imagestatus.v1.imagestatus_pb2.ImageErrors] = ...,
        warnings: typing.Optional[cloudvision.arista.imagestatus.v1.imagestatus_pb2.ImageWarnings] = ...,
        image_input_error: typing.Optional[google.protobuf.wrappers_pb2.StringValue] = ...,
        infos: typing.Optional[cloudvision.arista.imagestatus.v1.imagestatus_pb2.ImageInfos] = ...,
        ) -> None: ...
...
class WorkspaceSyncConfig(google.protobuf.message.Message):
    ...
    def key(self) -> global___WorkspaceSyncKey:
        ...
        pass
    @property
    def device_ids(self) -> cloudvision.fmp.wrappers_pb2.RepeatedString:
        """device_ids is the list of device Ids to be synced in the workspace."""
        pass
    def __init__(self,
        *,
        key: typing.Optional[global___WorkspaceSyncKey] = ...,
        device_ids: typing.Optional[cloudvision.fmp.wrappers_pb2.RepeatedString] = ...,
        ) -> None: ...
